...
| 지표 | Random Generation | Snowflake | 개선 효과 |
| :--- | :--- | :--- | :--- |
| **생성 속도** | Hashing + Retry 비용 발생 | **Bitwise 연산 (Zero Latency)** | **성능 극대화** |
| **확장성** | DB 부하 증가 (충돌 시) | **수평 확장 용이 (Stateless)** | **무한 확장 가능** |
| **안정성** | 충돌 확률 존재 | **충돌 없음 (Time+Node ID)** | **100% 유일성** |
