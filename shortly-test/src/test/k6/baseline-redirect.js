...
/**
 * Baseline Test: High-Load Redirection Test (Read-Heavy)
...
export function setup() {
    console.log('\n===== Baseline Test: Redirection High-Load Setup =====');
    ...
    console.log('===== Setup Complete. Starting baseline redirection test... =====\n');
...
export function handleSummary(data) {
    return {
        ...
        'baseline-report-redirect.html': htmlReport(data),
    };
}
